...
public class Resteasy3Provider implements ResteasyProvider {
	...
	@Override
	public void pushDefaultContextObject(@SuppressWarnings("rawtypes") Class type, Object instance) {
		ResteasyProviderFactory.getInstance();
	...
	public void pushContext(@SuppressWarnings("rawtypes") Class type, Object instance) {
		ResteasyProviderFactory.getInstance();
